...
if __name__ == "__main__":
    ...
    if ssl_enabled:
        ...
        app.run(host='0.0.0.0', port=server_config['ARK_WEB']['port'], ssl_context = context, threaded=True, debug=True)
    else:
        app.run(host='0.0.0.0', port=server_config['ARK_WEB']['port'], threaded=True, debug=True)