...
class ArkServer(object):
    def __init__(self, config, safe=False):
        ...
        if platform.system() == "Windows":
            self.binary = os.path.join('ARK', 'ShooterGame', 'Binaries', 'Win64', 'ShooterGameServer.exe')
        else:
            self.binary = os.path.join('ARK', 'ShooterGame', 'Binaries', 'Linux', 'ShooterGameServer')
